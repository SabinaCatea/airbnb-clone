...
const Header = () =>{
    return(
        ...
        <div className='flex text-center gap-1 items-center text-rose-500'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6 rotate-90">
        ...
        <div className='flex border px-4 py-2 rounded-full gap-2 shadow-md items-center'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#FF385C" class="w-9 h-9 ">
    ...
    <Link to="/login">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="grey" class="w-7 h-7">
